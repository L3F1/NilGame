# Existing geometry playground: mechanics and mathematical notes

This document preserves the tour of the existing experiments. The current
project direction and file map are in [README.md](../README.md), with active
work in [TODO.md](../TODO.md). Statements below about future priorities are
historical; the engine/editor roadmap takes precedence.
