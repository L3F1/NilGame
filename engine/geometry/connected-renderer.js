...
export function createConnectedRenderer(canvas,world) {
  ...
  const names=['uData','uCounts','uPosition','uForward','uRight','uUp','uResolution','uRegion','uDebug','uDiagnostics','uMaxDistance','uPolished','uAO'];
  ...
  function draw(state,{width=320,height=240,debug=0,timer=false,diagnostics=false,polished=true,ao=true}={}) {
