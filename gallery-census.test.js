...
const model={state,document:()=>({id:'fixture'}),pixelSight:()=>({status:'hit',regionId:'flat',query:{owner:'ball'},distance:2})};
const renderer={packed:{maxDistance:64,ids:['flat'],primitiveIds:['ball','wrong']},
  hardware:'synthetic',read:()=>({pixels:new Uint8Array([1,1,1,0]),distances:new Float32Array([2])})};
